...
const Product = class Product {
    ...
    constructor(product) {
        ...
        this.name = product[0] 
        this.price = parseFloat(product[1]) 
        this.availability = product[2]
    }
    /**
     * *****************
     * ***** TODO ******
    ...
    static inStock = (products) => { 
        ...
        return products.filter(product => {if (product.availability === "In Stock") return product} )
    }
    ...
    static printProducts = (products) => { 
        products.forEach((product) => {
            if (product.availability === "In Stock"){
                console.log(`Product: ${product.name}, Cost: $${product.price}, Available: Yes`)
            } else {
                console.log(`Product: ${product.name}, Cost: $${product.price}, Available: No`)
            }
        })
    }
